 ...
 ?>
				...
				<div class='texto-principal margen-interno margen' style="height: 95vh;">
					...
					<section 	class="principal upper maxw">
							...
							<h4 class="form-h4">Clientes registrados</h4>
					...
					<div id="datos" class="dope" style="min-height: 50vh; max-height: 50vh;"></div>
				...
				<script type="text/JavaScript" src="js/consulta/b_cli.js"></script>
